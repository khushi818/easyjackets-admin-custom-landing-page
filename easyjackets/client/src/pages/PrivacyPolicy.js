    ...
    <Layout title={"easyjackets-Privacy policy"}>
       <Container className="my-5">
            ...
            <div style={{  padding: "20px" }}>
                ...
                <p>This Privacy Policy governs the manner in which Easy Jackets collects, uses, maintains, and discloses information collected from users (each, a "User") of the www.clothoo.com website ("Site"). This privacy policy applies to the Site and all products and services offered by Easy Jackets.</p>
